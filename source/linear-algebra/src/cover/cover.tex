...
\begin{picture}(1,9.5)
  ...
  \put(0.18,8.5){\rotatebox[origin=lc]{-90}{\spinetext{Aljabar Linear}\hspace{2.15in}\spineauthortext{Hef{}feron}}}
  \setstackgap{S}{0.9ex}
...
Teks ini mencakup materi standar mata kuliah pertama:
Metode Gauss, ruang vektor, peta linear dan matriks, determinan,
serta nilai eigen dan vektor eigen.
Selain itu, setiap bab diakhiri dengan sejumlah topik singkat,
termasuk penerapannya.

Buku ini menonjol berkat motivasi yang disusun dengan cermat,
banyak contoh, dan kumpulan latihan yang luas.
Semua itu membantu setiap mahasiswa menguasai materi kuliah
sekaligus membantu pengajar mengembangkan kematangan matematis mahasiswa.

Buku ini telah tersedia secara bebas di internet selama bertahun-tahun.
Buku ini digunakan secara luas, baik di ruang kelas maupun untuk belajar mandiri.
Tersedia pula jawaban lengkap untuk semua latihan,
salindia proyeksi untuk penggunaan di kelas,
dan manual laboratorium berbasis \textit{Sage}.

\vspace{.2in}
\noindent\textbf{Pemenang Penghargaan Solow dari Mathematical Association of America:}\\[1.35ex]
\vspace{-.225in}
\begin{center}
\parbox{5.5in}{
``Gaya penulisan yang jelas, keragaman latihan yang luar biasa,
kemudahan penggunaan bersama strategi pembelajaran aktif, serta
perhatian saksama terhadap rincian dalam penyusunannya membuat teks ini
...
\begin{picture}(0,0)
  ...
  \put(0.0,0){\color{coverboldcolor}\fontsize{25pt}{8pt}\fontfamily{fos}\selectfont \textit{Pendekatan bertahap menuju}}
  \put(3.0,-.45){\color{black}\fontsize{25pt}{8pt}\fontfamily{fos}\selectfont \textbf{Aljabar Linear}}
\end{picture}
}
...
\begin{picture}(0,0) 
  ...
  \put(15.25,-3){\makebox[0pt][r]{\frontcovertext{Aljabar Linear}}}
  ...
  \put(15.25,-2.20){\makebox[0pt][r]{\frontcovereditiontext{Edisi keempat}}}
  \put(7.65,-9.5){\spine}

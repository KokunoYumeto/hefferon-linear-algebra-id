...
% \begin{answerlist}\item[]%
\chapter*{Prakata}
Berikut adalah jawaban latihan dalam \textit{Aljabar Linear} karya
J~Hef{}feron.
Jawaban yang di sini berlabel
One.II.3.4 merujuk pada soal nomor 4
dari bab pertama,
bagian kedua, dan subbagian ketiga.
Topik diberi nomor secara terpisah.

Jika Anda memiliki versi elektronik berkas ini,
simpanlah di direktori yang sama dengan buku.
Dengan demikian,
mengklik nomor soal dalam buku akan membawa Anda ke jawabannya,
dan mengklik nomor jawaban akan membawa Anda kembali ke soalnya.
(Berkas buku harus bernama `book.pdf', dan berkas jawaban ini harus
bernama `jhanswer.pdf'.
Nama berkas tersebut tidak dapat diubah karena cara kerja format PDF.)

Saya menyambut laporan kekeliruan dan komentar.
Informasi kontak tersedia di laman utama buku
\url{http://joshua.smcvt.edu/linearalgebra}.

\vspace{.5in}
\begin{raggedright}
Jim Hef{}feron     \\
Saint Michael's College, Colchester, Vermont, AS \\
